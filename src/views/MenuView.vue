  ...
  <div class="bg-gray-900 min-h-screen flex flex-col">
    <header class="py-8 px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col items-center justify-center mb-4">
        <img
          src="https://picsum.photos/seed/lobster/200"
          alt="icon"
          class="w-20 h-20 rounded-full object-cover border-2 border-gray-700 mb-2"
        />
        <h1 class="text-4xl font-serif text-yellow-600 text-center">Olga's Cafe</h1>
      </div>
    </header>
